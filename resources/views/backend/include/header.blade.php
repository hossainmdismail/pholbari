        ...
        <ul class="nav">
            ...
            <li class="dropdown nav-item">
                ...
                <div class="dropdown-menu dropdown-menu-end" aria-labelledby="dropdownAccount">
                    ...
                    <a class="dropdown-item text-danger" href="{{ route('admin.logout') }}" onclick="event.preventDefault(); document.getElementById('logout-form').submit();"><i class="material-icons md-exit_to_app"></i>Logout</a>
